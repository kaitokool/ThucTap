...
<head>
    ...
    <link href="{{asset('public/backend/css/main/main.css')}}" rel="stylesheet">

    <style>
        .app-header.header-text-light .app-header__logo .logo-src{
            background:url("{{asset('public/backend/image/main/logo.png')}}");
        }
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-header header-shadow">
            ...
            <div class="app-header__logo">
                <div class="logo-src" style="background: url('{{asset('public/backend/image/main/logo-inverse.png')}}')"></div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="{{asset('public/backend/image/main/anhcdung.jpg')}}" alt="">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="{{URL::to('/logout')}}" class="nav-link">Đăng Xuất</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="{{asset('public/backend/js/main/main.js')}}"></script>
</body>
</html>
