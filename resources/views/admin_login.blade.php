      ...
      <div class="forms-container">
        <div class="signin-signup">
            <?php
                ...
                if($message){
                    echo '<p style="position: absolute; justify-self: center; color: red">'.$message.'</p>';
                    Session::put('message',null);
                }
            ?>

        <form action="{{URL::to('/admin-dashboard')}}" class="sign-in-form" method="post">
            {{ csrf_field() }}
            <h2 class="title">Đăng nhập</h2>

            <div class="input-field">
                <i class="fas fa-user"></i>
                <input type="text" name="admin_name" placeholder="Tên Đăng Nhập" />
            </div>
